...
class DoctorCredentials extends StatefulWidget {
  const DoctorCredentials({super.key});

  @override
  State<DoctorCredentials> createState() => _DoctorCredentialsState();
}

class _DoctorCredentialsState extends State<DoctorCredentials> {
  @override
